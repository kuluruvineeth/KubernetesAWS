...
- Test by accessing the static html page
```
http://devops.onspot.click/app1/index.html
```
...
#Before
    ...
    external-dns.alpha.kubernetes.io/hostname: devops.onspot.click   

#After
    # External DNS - For creating a Record Set in Route53
    external-dns.alpha.kubernetes.io/hostname: devops.onspot.click, devops2.onspot.click       
```
- Commit the changes to local git repository and push to codeCommit Repository
- Monitor the codePipeline
- Test by accessing the static html page
...
- Test by accessing the static html page
```
http://devops2.onspot.click/app1/index.html
```
