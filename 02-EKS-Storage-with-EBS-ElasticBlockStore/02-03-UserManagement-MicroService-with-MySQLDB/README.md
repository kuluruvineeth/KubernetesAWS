...
- Import the postman project `AWS-EKS-Masterclass-Microservices.postman_collection.json` present in folder `02-03-UserManagement-MicroService-with-MySQLDB`
...
- **Create User Service**
  ...
  - `url` variable will be replaced from environment we selected
```json
    {
        "username": "admin1",
        "email": "vineethreddy3268@gmail.com",
        "role": "ROLE_ADMIN",
        "enabled": true,
        "firstname": "fname1",
        "lastname": "lname1",
