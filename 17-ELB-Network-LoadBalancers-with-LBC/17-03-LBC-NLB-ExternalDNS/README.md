...
```yaml
    ...
    external-dns.alpha.kubernetes.io/hostname: nlbdns101.onspot.click
```
...
nslookup nlbdns101.onspot.click

# Access Application
# Test HTTP URL
http://nlbdns101.onspot.click

# Test HTTPS URL
https://nlbdns101.onspot.click
```
