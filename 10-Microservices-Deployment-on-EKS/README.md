...
### AWS RDS Database
- We have created AWS RDS Database as part of section [04-EKS-Storage-with-RDS-Database](/04-EKS-Storage-with-RDS-Database/README.md)
...
-  **Email Addresses**
    ...
    - **From Address:** vineethreddy3268@gmail.com (replace with your ids during verification)
    - **To Address:** kuluruvineeth8623@gmail.com (replace with your ids during verification)
...
- Environment Variables
    ...
    - AWS_MAIL_SERVER_USERNAME=*****
    - AWS_MAIL_SERVER_PASSWORD=*****
    - AWS_MAIL_SERVER_FROM_ADDRESS=vineethreddy3268@gmail.com
...
```yml
          ...
          - name: AWS_MAIL_SERVER_FROM_ADDRESS
            value: "vineethreddy3268@gmail.com"
```
...
```yml
    ...
    external-dns.alpha.kubernetes.io/hostname: services.onspot.click, ums.onspot.click
spec:
  rules:
    - http:
        paths:
...
https://services.onspot.click/usermgmt/health-status

# Notification Microservice Health-Status via User Management
https://services.onspot.click/usermgmt/notification-health-status
https://services.onspot.click/usermgmt/notification-service-info
```

## Step-12: Import postman project to Postman client on our desktop. 
- Import postman project
- Add environment url 
    - https://services.onspot.click (**Replace with your ALB DNS registered url on your environment**)
