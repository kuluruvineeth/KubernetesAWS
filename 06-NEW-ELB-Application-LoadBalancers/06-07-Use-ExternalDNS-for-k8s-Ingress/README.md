...
```yaml
    ...
    external-dns.alpha.kubernetes.io/hostname: dnstest901.onspot.click, dnstest902.onspot.click
```
...
- You should see **Record Sets** added for `dnstest901.onspot.click`, `dnstest902.onspot.click`
...
```t
# nslookup commands
nslookup dnstest901.onspot.click
nslookup dnstest902.onspot.click
```
### Access Application using dnstest1 domain
```t
# HTTP URLs (Should Redirect to HTTPS)
http://dnstest901.onspot.click/app1/index.html
http://dnstest901.onspot.click/app2/index.html
http://dnstest901.onspot.click/
```

### Access Application using dnstest2 domain
```t
# HTTP URLs (Should Redirect to HTTPS)
http://dnstest902.onspot.click/app1/index.html
http://dnstest902.onspot.click/app2/index.html
http://dnstest902.onspot.click/
```
...
- The below records should be deleted automatically
  - dnstest901.onspot.click
  - dnstest902.onspot.click
```
