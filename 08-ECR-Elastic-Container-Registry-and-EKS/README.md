...
- We will access the ECR Demo Application using registered dns `http://ecrdemo.onspot.click`
...
- Navigate to folder **08-ECR-Elastic-Container-Registry\01-aws-ecr-kubenginx** from course github content download. 
...
- Understand the Deployment and Service kubernetes manifests present in folder **08-ECR-Elastic-Container-Registry\02-kube-manifests**
...
- Verify Route 53 DNS registration `ecrdemo.onspot.click`
```
# Get external ip of EKS Cluster Kubernetes worker nodes
kubectl get nodes -o wide

# Access Application
http://ecrdemo.onspot.click/index.html
```
