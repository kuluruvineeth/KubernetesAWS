...
- Provide **desired domain: somedomain.com** and click on **check** (In my case its going to be `onspot.click`)
...
- Click on **Request a Certificate**
  ...
  - Add domain names: *.yourdomain.com (in my case it is going to be `*.onspot.click`)
...
- Go to **Hosted Zones**
  - Click on **yourdomain.com** (in my case onspot.click)
- Create a **Record Set**
  - **Name:** ssldemo101.onspot.click
  - **Alias:** yes
...
- **Access Application**
- **Important Note:** Instead of `onspot.click` you need to replace with your registered Route53 domain (Refer pre-requisite Step-02)
```t
# HTTP URLs
