...
- You should see **Record Sets** added for 
  - target-type-ip-501.onspot.click 
...
```t
# nslookup commands
nslookup target-type-ip-501.onspot.click 
```
### Access Application using DNS domain
```t
# Access App1
http://target-type-ip-501.onspot.click/app1/index.html

# Access App2
http://target-type-ip-501.onspot.click/app2/index.html

# Access Default App (App3)
http://target-type-ip-501.onspot.click 
```
