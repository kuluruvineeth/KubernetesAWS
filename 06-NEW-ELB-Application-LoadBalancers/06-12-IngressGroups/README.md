...
```t
# Web URLs
http://ingress-groups-demo601.onspot.click/app1/index.html
http://ingress-groups-demo601.onspot.click/app2/index.html
http://ingress-groups-demo601.onspot.click
```
...
- The below records should be deleted automatically
  - ingress-groups-demo601.onspot.click
```
